...
var mvpComponents = []Component{
	...
	{ID: model.ComponentPersona, Name: "Persona", Description: "Gentleman, Rick Sanchez, neutral or custom behavior"},
	...
	{ID: model.ComponentCodeGraph, Name: "CodeGraph", Description: "Semantic code knowledge graph"},
}
