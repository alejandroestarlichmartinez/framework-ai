...
const (
	markerPrefix = "<!-- framework-ai:"
	markerSuffix = " -->"
	closePrefix  = "<!-- /framework-ai:"
)
...
// written to a markdown file outside of <!-- framework-ai: --> markers.
//
...
// <!-- framework-ai: --> marker). A fingerprint that exists only inside a marker
...
// written by the standalone ATL installer before framework-ai superseded it.
...
// <!-- framework-ai:sdd-orchestrator --> section, so keeping both wastes ~150
...
// Markers use HTML comments: <!-- framework-ai:SECTION_ID --> ... <!-- /framework-ai:SECTION_ID -->
