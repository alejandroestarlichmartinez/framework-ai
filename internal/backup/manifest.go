...
type Manifest struct {
	...
	// CreatedByVersion is the framework-ai version that created this backup.
...
func backupRoot() (string, error) {
	...
	return filepath.Join(home, ".framework-ai", "backups"), nil
}
...
// of the expected backup root (~/.framework-ai/backups/). This prevents a tampered
