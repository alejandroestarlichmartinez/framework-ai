...
Gentle AI writes to the global steering file (`~/.kiro/steering/framework-ai.md`) — treat it as your active working context alongside your project steering files.
