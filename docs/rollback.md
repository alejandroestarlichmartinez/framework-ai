...
Every time you run `framework-ai install`, `sync`, or `upgrade`, the system:
...
1. Run `framework-ai` and navigate to the **Backups** screen
...
2. Restore from latest snapshot via the TUI or `framework-ai restore latest`
