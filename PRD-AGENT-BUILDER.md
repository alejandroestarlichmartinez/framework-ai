...
```
~/.config/framework-ai/custom-agents.json
```
...
```markdown
<!-- framework-ai:custom-agent:{name} -->
## Custom Agent: {Title}
...
graph TB
    ...
    subgraph STORAGE["Storage"]
        ...
        REGISTRY_FILE["~/.config/framework-ai/custom-agents.json"]
...
| R-AB-08 | The Agent Builder MUST maintain a local registry of custom agents at `~/.config/framework-ai/custom-agents.json` | P0 |
