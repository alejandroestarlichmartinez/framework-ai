...
1. **`chained-pr/SKILL.md`** had `name: framework-ai-chained-pr` but the directory slug is `chained-pr`. Fixed in commit 1b2b374. The `name:` field now equals `chained-pr`.
