...
ok  	github.com/gentleman-programming/framework-ai/internal/components/sdd	(cached)
...
ok  	github.com/gentleman-programming/framework-ai/internal/components	1.792s
```
...
```text
go test ./... -coverprofile=/var/folders/k1/2nnhpdfx0wq8k6w8n2nqx9_h0000gn/T/opencode/framework-ai-sdd-verify-pi-rerun.cover
# all packages passed; exit 0

go tool cover -func=/var/folders/k1/2nnhpdfx0wq8k6w8n2nqx9_h0000gn/T/opencode/framework-ai-sdd-verify-pi-rerun.cover
