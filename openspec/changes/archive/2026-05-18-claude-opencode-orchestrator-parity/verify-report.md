...
ok  	github.com/gentleman-programming/framework-ai/internal/assets	0.004s

go test ./internal/components -run 'TestGoldenSDD_Claude|TestGoldenCombined_Claude' -count=1
ok  	github.com/gentleman-programming/framework-ai/internal/components	0.780s
...
ok  	github.com/gentleman-programming/framework-ai/internal/assets	0.005s
ok  	github.com/gentleman-programming/framework-ai/internal/components	1.457s

go test ./...
?   	github.com/gentleman-programming/framework-ai/cmd/framework-ai	[no test files]
ok  	github.com/gentleman-programming/framework-ai/internal/app	7.492s
ok  	github.com/gentleman-programming/framework-ai/internal/assets	0.009s
ok  	github.com/gentleman-programming/framework-ai/internal/cli	41.381s
ok  	github.com/gentleman-programming/framework-ai/internal/components	10.977s
ok  	github.com/gentleman-programming/framework-ai/internal/components/sdd	50.442s
...
ok  	github.com/gentleman-programming/framework-ai/internal/assets	0.027s	coverage: 27.3% of statements
ok  	github.com/gentleman-programming/framework-ai/internal/components	1.450s	coverage: [no statements]
...
github.com/gentleman-programming/framework-ai/internal/assets/assets.go:9:       MustRead                75.0%
github.com/gentleman-programming/framework-ai/internal/assets/assets.go:18:      Read                    0.0%
github.com/gentleman-programming/framework-ai/internal/assets/commands.go:8:    SDDCommandsAssetDir     0.0%
total:                                                                  27.3%
```
